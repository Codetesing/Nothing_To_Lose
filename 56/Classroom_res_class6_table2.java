...
public class Classroom_res_class6_table2 extends AppCompatActivity {
...
//        //버튼 0값 불러오기
    ...
    void showDialog(Button btn, int btn_key) {
        AlertDialog.Builder msg = new AlertDialog.Builder(Classroom_res_class6_table2.this)
                ...
                .setPositiveButton(Html.fromHtml("<font color='#0'>아니요</font>"), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(Classroom_res_class6_table2.this, "자리 사용 등록이 취소되었습니다.", Toast.LENGTH_SHORT).show();
                    }
                })
                .setNegativeButton(Html.fromHtml("<font color='#0'>예</font>"), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        // 등록 완료 팝업.
                        Toast.makeText(Classroom_res_class6_table2.this, "자리 사용 등록이 완료되었습니다.", Toast.LENGTH_SHORT).show();
    ...
    Boolean already_Registed(int btn_key) {
        switch (btn_key) {
            case 0:
                if (btn_status0 == true) {
                    Toast.makeText(Classroom_res_class6_table2.this, "이미 신청된 자리입니다.", Toast.LENGTH_SHORT).show();
                    return true;
                }
                break;
            //false true
