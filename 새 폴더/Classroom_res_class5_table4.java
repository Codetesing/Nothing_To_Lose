...
public class Classroom_res_class5_table4 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //버튼 layout 연결
        SharedPreferences sharedPreferences0 = getSharedPreferences(on0, 0);
        boolean value0 = sharedPreferences0.getBoolean("ison?5_3_0", false);
        btn_status0 = value0;
        isOn(btn0, btn_status0);
//        //버튼 0값 불러오기
        SharedPreferences sharedPreferences1 = getSharedPreferences(on1, 0);
        boolean value1 = sharedPreferences1.getBoolean("ison?5_3_1", false);
        btn_status1 = value1;
        isOn(btn1, btn_status1);
        //버튼 1값 불러오기
        SharedPreferences sharedPreferences2 = getSharedPreferences(on2, 0);
        boolean value2 = sharedPreferences2.getBoolean("ison?5_3_2", false);
        btn_status2 = value2;
        isOn(btn2, btn_status2);
        //버튼 2값 불러오기
        SharedPreferences sharedPreferences3 = getSharedPreferences(on3, 0);
        boolean value3 = sharedPreferences3.getBoolean("ison?5_3_3", false);
        btn_status3 = value3;
    ...
    void showDialog(Button btn, int btn_key) {
        AlertDialog.Builder msg = new AlertDialog.Builder(Classroom_res_class5_table4.this)
                ...
                .setPositiveButton(Html.fromHtml("<font color='#0'>아니요</font>"), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(Classroom_res_class5_table4.this, "자리 사용 등록이 취소되었습니다.", Toast.LENGTH_SHORT).show();
                    }
                })
                .setNegativeButton(Html.fromHtml("<font color='#0'>예</font>"), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        // 등록 완료 팝업.
                        Toast.makeText(Classroom_res_class5_table4.this, "자리 사용 등록이 완료되었습니다.", Toast.LENGTH_SHORT).show();
    ...
    void hmanyRegisted()
    {
        ...
        intent.putExtra("cnt4",sendText); // 바꿔야함
    ...
    Boolean already_Registed(int btn_key) {
        switch (btn_key) {
            case 0:
                if (btn_status0 == true) {
                    Toast.makeText(Classroom_res_class5_table4.this, "이미 신청된 자리입니다.", Toast.LENGTH_SHORT).show();
                    return true;
                }
                break;
            //false true
    ...
    protected void onDestroy() {
        ...
        editor0.putBoolean("ison?5_3_0",ison0);
        editor0.commit();

        SharedPreferences sharedPreferences1 = getSharedPreferences(on1, 0);
        SharedPreferences.Editor editor1 = sharedPreferences1.edit();
        Boolean ison1 = btn_status1;
        editor1.putBoolean("ison?5_3_1",ison1);
        editor1.commit();

        SharedPreferences sharedPreferences2 = getSharedPreferences(on2, 0);
        SharedPreferences.Editor editor2 = sharedPreferences2.edit();
        Boolean ison2 = btn_status2;
        editor2.putBoolean("ison?5_3_2",ison2);
        editor2.commit();

        SharedPreferences sharedPreferences3 = getSharedPreferences(on3, 0);
        SharedPreferences.Editor editor3 = sharedPreferences3.edit();
        Boolean ison3 = btn_status3;
        editor3.putBoolean("ison?5_3_3",ison3);
        editor3.commit();
